...
static const int HORIZONTAL_RESOLUTION = 480; // Pixels wide
static const int VERTICAL_RESOLUTION = 480;   // Pixels tall
static const byte HORIZONTAL_BYTES = HORIZONTAL_RESOLUTION / 8;
static const int VERTICAL_LINES = VERTICAL_RESOLUTION / 16;

// ------------------------ Hardware Definitions ------------------------------
static const byte HSYNC_PIN = 3;
static const byte RED_PIN = 4;
static const byte GREEN_PIN = 5;
static const byte BLUE_PIN = 6;
static const byte VSYNC_PIN = 10;

// ------------------------- Timing Constants ---------------------------------
static const byte VERTICAL_BACK_PORCH = 35; // Includes sync pulse
static const int VERTICAL_FRONT_PORCH = 525 - VERTICAL_BACK_PORCH;
...
static const SwipeDirection DIRECTION = RIGHT_TO_LEFT;
static const int FRAMES_PER_MOVE = 0;
static const int LINE_THICKNESS = 5;
static const byte COLOR_WHITE = 0x70; // BGR format (0b01110000)
...
void initializeDisplay()
{
  ...
  {
  case RIGHT_TO_LEFT:
    currentPosition = HORIZONTAL_BYTES - 1;
    break;
  case BOTTOM_TO_TOP:
    currentPosition = VERTICAL_LINES - 1;
    break;
  default:
    currentPosition = 0;
  }
...
{
  if (frameCounter++ < FRAMES_PER_MOVE)
    return;
  frameCounter = 0;
